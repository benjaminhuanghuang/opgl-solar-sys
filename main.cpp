...
int main()
{
    ...
    Shader directionalShader("shaders/directional.vs", "shaders/directional.frag");
    Shader lampShader("shaders/lamp.vs", "shaders/lamp.frag");

    // Load models
    Model earthModel("models/earth/Earth.obj");
    Model space("models/space/space.obj");
    Model sunModel("models/sun/sun.obj");
    Model mercuryModel("models/mercury/mercury.obj");
    Model venusModel("models/venus/venus.obj");
    Model marsModel("models/mars/mars.obj");
    Model jupiterModel("models/jupiter/jupiter.obj");
    Model saturnModel("models/saturn/13906_Saturn_v1_l3.obj");
    Model uranusModel("models/uranus/13907_Uranus_v2_l3.obj");
    Model neptuneModel("models/neptune/13908_Neptune_v2_l3.obj");
